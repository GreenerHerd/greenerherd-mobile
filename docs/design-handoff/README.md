...
The design is stored /design_handoff/greenerherd_app and please use the README.md, this is the main source of UI Design.
...
- `species/cattle.svg`, `species/goat.svg`, `species/sheep.svg` — legacy line-art fallbacks
- `icons/cattle_green.png`, `cattle_white.png`, `goat_green.png`, `goat_white.png`, `sheep_green.png`, `sheep_white.png` — species avatar tiles (512×512)
